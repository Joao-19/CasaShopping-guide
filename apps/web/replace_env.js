    ...
    try {
        ...
        ENVS.forEach(envKey => {
            ...
            if (content.includes(placeholder)) {
                ...
                changed = true;
                // Log non-empty replacements for debugging (masking sensitive info if needed, but these are public vars)
                if (value) {
...
console.log('Starting runtime env replacement for Web App...');
