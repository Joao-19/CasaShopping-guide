            ...
            <div className="min-h-screen bg-[#f0f1f3] font-sans antialiased">
                <div className="relative w-full min-h-screen bg-[#f0f1f3]">
                    <div className="w-full bg-[rgba(240,241,243,0)] min-h-screen pb-20">
                        <header className="absolute top-0 left-0 right-0 h-[100px] z-50 bg-linear-to-b from-black/50 to-transparent bg-[rgba(0,59,166,0)]">
                            <div className="max-w-7xl mx-auto px-8 h-full flex items-center justify-between bg-[rgba(26,43,60,0)] border-b border-white/30">
                                <div className="flex items-center gap-12">
                                    ...
                                    <nav className="hidden md:flex items-center gap-8"><button className="text-white font-semibold text-[16px] hover:opacity-80 transition-opacity">Home</button><button className="text-white/80 font-medium text-[16px] hover:text-white transition-colors relative">Promoções Exclusivas<span className="absolute -top-1 -right-2 w-2 h-2 bg-red-500 rounded-full animate-pulse"></span></button><button className="text-white/80 font-medium text-[16px] hover:text-white transition-colors">
                                        Lojas
                                    </button>
                                        <button className="text-white/80 font-medium text-[16px] hover:text-white transition-colors">Categorias</button><button className="text-white/80 font-medium text-[16px] hover:text-white transition-colors">
                                            Blog
                                        </button>
                                    </nav>
                                </div>
                                <div className="flex items-center gap-8">
                                    <button className="group flex items-center ga hover:opacity-80 transition-opacity relative">
                                    ...
                                    <div className="flex items-center gap-3 cursor-pointer group bg-[rgba(0,59,166,0)]">
                                        ...
                                        <div className="flex flex-col items-start"><span className="text-white font-semibold text-[14px] leading-tight group-hover:underline">Olá, Visitante</span><span className="text-white/70 text-[12px] leading-tight">Meu Perfil</span></div>
                                    </div>
                                </div>
                            </div>
                        </header>
                        <div className="relative h-[800px] w-full">
                            <div className="absolute inset-0">
                                <video src="https://dgqh380xariug.cloudfront.net/f4vy6b%2Ffile%2F94b2a36d401b4de616194fd7cdf6c833_1191bf7fabeb25d8d2eb57926af85f0b.mp4?response-content-disposition=inline%3Bfilename%3D%2294b2a36d401b4de616194fd7cdf6c833_1191bf7fabeb25d8d2eb57926af85f0b.mp4%22%3B&amp;response-content-type=video%2Fmp4&amp;Expires=1765907216&amp;Signature=ZBHw13~VFhpBli7kRb60Kwo1mmHSP7KKrNClWlw9a2~KdO8GFXwDhXENECW1EwqxVEs~dqMCfV-sHhBQDCuFn-OSDvM-zWRUJ33sqMZ6Abr8k1-CGykrfFDR97PsfwGR54REfAG42K8Amvo7OycW1j6aTzjUS0VuzIOE9JiK4xYC6CwmjD3q3NBVeRirNJQ~t~aMEJEbZt~a5DROGS-zonBtdUo-BXfy02hwHK6qybEvcDJEG6A1A7S1ksauq3VOiPGmRC3xLUDBmfEmprs3oCTJxkgsJtK2jioKKFH7BSkuh-4~pnjUkwzlWlpSiUp2QoKdA6HuBrZGK7-oZpH-Ww__&amp;Key-Pair-Id=APKAJT5WQLLEOADKLHBQ" className="w-full h-full object-cover" loop playsInline>
                                </video>
                                        ...
                                        <div className="bg-white rounded-[16px] h-[72px] w-full flex items-center px-[24px] gap-[16px] shadow-2xl cursor-text transition-transform hover:scale-[1.01] duration-300">
                                            <div className="size-[24px] shrink-0 text-primary">
                                                <svg className="size-full" viewBox="0 0 21 21" fill="none">
                                                    <path d="M9.52583 2.94583C10.7894 2.94468 12.0249 3.31832 13.0761 4.01948C14.1273 4.72065 14.9469 5.71784 15.4313 6.8849C15.9156 8.05196 16.0429 9.33645 15.7971 10.5759C15.5513 11.8153 14.9434 12.954 14.0504 13.8479C13.1573 14.7418 12.0192 15.3507 10.78 15.5977C9.54074 15.8446 8.25613 15.7185 7.08863 15.2352C5.92112 14.7519 4.92319 13.9332 4.22106 12.8826C3.51894 11.8321 3.14417 10.5969 3.14417 9.33333C3.15183 7.64263 3.82645 6.02327 5.02143 4.82721C6.2164 3.63114 7.83514 2.95504 9.52583 2.94583V2.94583ZM9.52583 1.75C8.02599 1.75 6.55983 2.19475 5.31276 3.02802C4.06569 3.86129 3.09371 5.04564 2.51975 6.43132C1.94578 7.81699 1.79561 9.34175 2.08821 10.8128C2.38082 12.2838 3.10306 13.635 4.16361 14.6956C5.22416 15.7561 6.57538 16.4783 8.0464 16.771C9.51742 17.0636 11.0422 16.9134 12.4278 16.3394C13.8135 15.7655 14.9979 14.7935 15.8311 13.5464C16.6644 12.2993 17.1092 10.8332 17.1092 9.33333C17.1092 7.32211 16.3102 5.39326 14.8881 3.97111C13.4659 2.54896 11.5371 1.75 9.52583 1.75Z" fill="currentColor"></path>
                                                    <path d="M20.4167 19.4192L16.1175 15.0908L15.2892 15.9133L19.5883 20.2417C19.6423 20.2961 19.7065 20.3393 19.7772 20.3689C19.8479 20.3984 19.9238 20.4138 20.0004 20.4141C20.0771 20.4143 20.153 20.3995 20.2239 20.3704C20.2949 20.3414 20.3594 20.2986 20.4137 20.2446C20.4681 20.1906 20.5114 20.1264 20.5409 20.0557C20.5705 19.985 20.5859 19.9091 20.5862 19.8325C20.5864 19.7558 20.5716 19.6799 20.5425 19.609C20.5134 19.538 20.4707 19.4736 20.4167 19.4192Z" fill="currentColor"></path>
                                                </svg>
                                            </div>
                                        ...
                                        <div className="absolute top-4 right-4 flex ga">
                                            <div className="w-10 h-10 rounded-full backdrop-blur-md flex items-center justify-center transition-colors z-20 cursor-pointer bg-white/10 hover:bg-white/20">
                                                <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="none">
                                                    <path d="M7.5 3.5C4.46244 3.5 2 5.96245 2 9C2 14.5 8.5 19.5 12 20.6631C15.5 19.5 22 14.5 22 9C22 5.96245 19.5375 3.5 16.5 3.5C14.6399 3.5 12.9954 4.42345 12 5.8369C11.0046 4.42345 9.36015 3.5 7.5 3.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"></path>
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="flex gap-4">
                                            <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors text-white">
                                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                    <path fill-rule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772 4.902 4.902 0 011.772-1.153c.636-.247 1.363-.416 2.427-.465 1.067-.047 1.407-.06 3.808-.06zm0 1.838c-2.39 0-2.673.012-3.621.054-.877.04-1.352.2-1.666.322-.416.161-.712.353-1.024.665-.312.312-.504.608-.665 1.024-.122.314-.282.788-.322-1.666.042-.948.054-1.23.054 3.621v.53c0 2.39.012 2.673.054 3.621.04.877.2 1.352.322 1.666.161.416.353.712.665 1.024.312.312.608.504 1.024.665.314.122.788.282 1.666.322-1.666.042-.948.054-1.23.054-3.621v-.53c0-2.39-.012-2.673-.054-3.621-.04-.877-.2-1.352-.322-1.666-.161-.416-.353-.712-.665-1.024-.312-.312-.608-.504-1.024-.665-.314-.122-.788-.282-1.666-.322-.948-.042-1.23-.054-3.621-.054h-.53zm0 4.545a3.678 3.678 0 110 7.356 3.678 3.678 0 010-7.356zm0 1.838a1.838 1.838 0 100 3.677 1.838 1.838 0 000-3.677z" clip-rule="evenodd"></path>
                                                </svg>
                                            </a>
                                            <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors text-white">
                                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
