            ...
            <div className="space-y-6">
                <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <button
                        ...
                        className="w-full md:w-auto bg-[#1A2B3C] text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 hover:bg-[#2c455d] transition-colors text-sm font-medium"
                    >
